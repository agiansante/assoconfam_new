...
if ( ! class_exists( 'TheVoux_plugin' ) ) {
	$thb_plugin = false;
}
?>
<div class="theme-browser thb-demo-import thb-content">
	...
	if ( ! $cond && $thb_plugin ) {
		...
		?>
		<div class="thb-error">
			<p><span class="dashicons dashicons-warning"></span> Please install <strong>The Voux Required Plugin</strong> on the previous tab first.</p>
		</div>
		<?php
	} else {
	...
	foreach ( $demos as $demo ) {
		...
		if ( ! $cond ) {
			...
			<div class="theme-actions">
				...
				if ( ! $cond ) {
					?>
					disabled<?php } ?>" data-demo="<?php echo esc_attr( $i++ ); ?>">Import Options</span>

...
function thb_get_listing_templates( $template_list ) {
	...
	$template_list['listing_25'] = array(
		'name'      => esc_html__( 'Listing - 25', 'thevoux' ),
		'thumbnail' => Thb_Theme_Admin::$thb_theme_directory_uri . 'assets/img/admin/demos/listing/listing_e25.jpg',
		'cat'       => array( 'Listing', 'Listing-Sidebar' ),
		'sc'        => '[vc_row css=".vc_custom_1611578106856{padding-bottom: 6vh !important;}"][vc_column][vc_column_text]<p style="text-align: center;"><span style="color: #000000; font-size: 17px; font-weight: 500; letter-spacing: 0.2em;">THE LATEST ARTICLES</span></p>[/vc_column_text][vc_empty_space][thb_postgrid style="style16" columns="3" pagination="style2" disable_excerpts="true" item_count="7" source="size:9|post_type:post" offset="4"][/vc_column][/vc_row]',
	);

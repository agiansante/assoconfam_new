...
<header class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
	...
	<div class="header_top cf">
		<?php if ( $header_video ) { ?>
			<div class="thb-header-video" data-vide-bg="mp4: <?php echo esc_url( $header_video ); ?>
																		<?php
																		if ( $header_bg_img ) {
																			?>
				, poster: <?php echo esc_attr( $header_bg_img ); ?><?php } ?>" data-vide-options="posterType: 'auto', autoplay: true, loop: true, muted: true, position: 50% 50%, resizing: true">
				<div class="thb-header-video-overlay"></div>
			</div>
		<?php } ?>
		<div class="row align-middle">
			<div class="small-3 large-4 columns toggle-holder social-holder <?php echo esc_attr( $social_style = ot_get_option( 'header_socialstyle', 'style1' ) ); ?>">

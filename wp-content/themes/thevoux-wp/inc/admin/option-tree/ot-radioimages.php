...
function thb_filter_radio_images( $array, $field_id ) {
	...
	if ( $field_id === 'subfooter_style' ) {
		$array = array(
			...
			array(
				'value' => 'style3',
				'label' => esc_html__( 'Style 3', 'thevoux' ),
				'src'   => Thb_Theme_Admin::$thb_theme_directory_uri . 'assets/img/admin/subfooter_styles/style3.png',
			),
		);
	}
	...
	if ( $field_id === 'header_style' ) {
		$array = array(
			...
			array(
				'value' => 'style10',
				'label' => esc_html__( 'Style 10', 'thevoux' ),
				'src'   => Thb_Theme_Admin::$thb_theme_directory_uri . 'assets/img/admin/header_styles/style10.png',
			),
		);
	}
	...
	if ( $field_id === 'footer_columns' ) {
		$array = array(
			...
			array(
				...
				'label' => esc_html__( 'Five Columns - Larger Left Columns', 'thevoux' ),

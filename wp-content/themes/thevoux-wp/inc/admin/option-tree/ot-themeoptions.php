...
function thb_custom_theme_options() {
	...
	$custom_settings = array(
		'sections' => array(
			...
			array(
				'title' => esc_html__( 'Sub-Footer Settings', 'thevoux' ),
				'id'    => 'subfooter',
			),
			array(
		...
		'settings' => array(
			...
			array(
				'label'        => esc_html__( 'Newsletter Delay', 'thevoux' ),
				'id'           => 'newsletter_delay',
				'std'          => '0',
				'type'         => 'numeric-slider',
				'min_max_step' => '0,120,1',
				'desc'         => esc_html__( 'You can delay the newsletter popup reveal by certain seconds.', 'thevoux' ),
				'section'      => 'general',
				'condition'    => 'newsletter:is(on)',
			),
			array(
			...
			array(
				'label'     => esc_html__( 'Restrict Infinite loading to Same Categories?', 'thevoux' ),
				'id'        => 'infinite_load_category',
				'type'      => 'on_off',
				'desc'      => esc_html__( 'You can restrict infinite scrolling to articles in the same category.', 'thevoux' ),
				'std'       => 'off',
				'section'   => 'articles',
			...
			array(
				'label'   => esc_html__( 'Standard Format - Featured Image', 'thevoux' ),
				'id'      => 'standard_format_featured',
				'type'    => 'on_off',
				'desc'    => esc_html__( 'You can choose to display the featured image by default on Standard Format posts.', 'thevoux' ),
				'std'     => 'off',
				'section' => 'articles',
			),
			array(
			...
			array(
				...
				'type'      => 'text',
				'desc'      => __( 'Facebook Application ID, more info <a href="https://joobi.org/old-documentation/item/how-to-get-a-facebook-app-id-for-your-website.html" target="_blank">here</a>', 'thevoux' ),
				'section'   => 'social',
			...
			array(
				'label'     => esc_html__( 'Sub-Footer Menu', 'thevoux' ),
				'id'        => 'subfooter_menu',
				'type'      => 'menu_select',
				'section'   => 'subfooter',
				'operator'  => 'or',
			...
			array(
				'label'     => esc_html__( 'Sub-Footer Text Content', 'thevoux' ),
				'id'        => 'subfooter_text',
				'type'      => 'text',
				'desc'      => esc_html__( 'Enter your desired text for footer', 'thevoux' ),
				'section'   => 'subfooter',
			...
			array(
				'label'     => esc_html__( 'Display Sub-Footer Logo?', 'thevoux' ),
				'id'        => 'subfooter_logo',
				'type'      => 'on_off',
				'desc'      => esc_html__( 'Would you like to display the Subfooter Logo?', 'thevoux' ),
				'std'       => 'off',
				'section'   => 'subfooter',
				'condition' => 'subfooter_style:is(style3)',
			),
			array(
				'label'     => esc_html__( 'Sub-Footer Logo', 'thevoux' ),
				'id'        => 'subfooter_logo_upload',
				'type'      => 'upload',
				'desc'      => esc_html__( 'You can upload your own subfooter logo here. Since this theme is retina-ready, <strong>please upload a double size image.</strong>', 'thevoux' ),
				'section'   => 'subfooter',
				'condition' => 'subfooter_logo:is(on)',
			),
			array(
				'label'     => esc_html__( 'Sub-Footer Logo Height', 'thevoux' ),
				'id'        => 'subfooter_logo_height',
				'type'      => 'measurement',
				'desc'      => esc_html__( 'You can modify the subfooter logo height from here. This is maximum height, so your logo may get smaller depending on screen size', 'thevoux' ),
				'section'   => 'subfooter',
				'condition' => 'subfooter_logo:is(on)',
			),
			array(
			...
			array(
				'label'   => esc_html__( 'Sub-Footer Padding', 'thevoux' ),
				'id'      => 'subfooter_padding',
				'type'    => 'spacing',
				'desc'    => esc_html__( 'You can modify the sub-footer bar padding here', 'thevoux' ),
				'section' => 'footer',
			),
			array(
				'id'      => 'misc_tab0',

...
<footer class="post-links">
	<a href="<?php echo esc_url( get_comments_link( $post->ID ) ); ?>" title="<?php the_title_attribute(); ?>" class="post-link comment-link"><?php get_template_part( 'assets/svg/comment.svg' ); ?></a> 

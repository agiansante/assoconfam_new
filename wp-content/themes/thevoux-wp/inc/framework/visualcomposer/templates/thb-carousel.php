...
function thb_get_carousel_templates( $template_list ) {
	...
	$template_list['carousel_09'] = array(
		'name'      => esc_html__( 'Carousel - 09', 'thevoux' ),
		'thumbnail' => Thb_Theme_Admin::$thb_theme_directory_uri . 'assets/img/admin/demos/carousel/carousel_e9.jpg',
		'cat'       => array( 'Carousel' ),
		'sc'        => '[vc_row column_padding="false" full_width_row="true" css=".vc_custom_1611308842361{padding-top: 60px !important;padding-bottom: 60px !important;background-color: #f5efeb !important;}"][vc_column][vc_column_text]<p style="text-align: center;"><span style="color: #000000; font-size: 17px; font-weight: 500; letter-spacing: 0.2em;">TRENDING NEWS</span></p>[/vc_column_text][vc_empty_space][vc_row_inner max_width="true"][vc_column_inner][thb_postcarousel style="style6" columns="4" center="" pagination="true" autoplay="" source="size:6|post_type:post|categories:5"][/vc_column_inner][/vc_row_inner][/vc_column][/vc_row]',
	);

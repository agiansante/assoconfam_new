...
function thb_get_hero_templates( $template_list ) {
	...
	$template_list['hero_15'] = array(
		'name'      => esc_html__( 'Hero - 15', 'thevoux' ),
		'thumbnail' => Thb_Theme_Admin::$thb_theme_directory_uri . 'assets/img/admin/demos/hero/hero_e15.jpg',
		'cat'       => array( 'Hero', 'Sliders' ),
		'sc'        => '[vc_row column_padding="false" full_width_row="true"][vc_column][thb_postslider navigation="true" autoplay="true" source="size:3|post_type:post" thb_slider_height="520px" thb_slider_height_mobile="400px"][/vc_column][/vc_row]',
	);

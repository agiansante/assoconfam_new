...
class thbShares {
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'thevoux' ), '1.7' ); }
	...
	public function init() {
		require_once get_theme_file_path( '/inc/framework/thb-social-shares/social-share-functions.php' );

							...
							<div class="small-12 columns">
								<div class="category_container">
									<div class="inner">
										...
										get_template_part( 'inc/templates/loop/style5' );
										?>
					<?php } ?>
						<?php if ( $i == 1 ) { ?>
								<?php
...
endwhile; // end of the loop.
	...
	set_query_var( 'thb_style', null );
	set_query_var( 'thb_class', null );
	set_query_var( 'thb_excerpt', null );
	set_query_var( 'thb_image_size', null );
	wp_reset_query();
	wp_reset_postdata();

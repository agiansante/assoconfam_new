<table class="widefat" cellspacing="0">
	<thead>
		...
		<?php if ( function_exists( 'ini_get' ) ) : ?>
			...
			<tr>
				<td><?php esc_html_e( 'PHP Version:', 'thevoux' ); ?></td>
				<td>
					<?php
			...
			<tr>
				<td><?php esc_html_e( 'PHP Time Limit', 'thevoux' ); ?>:</td>
				<td>
					<?php
		...
		<?php endif; ?>
		<tr>
			<td><?php esc_html_e( 'Max Upload Size', 'thevoux' ); ?>:</td>
			<td>
				<?php
		...
		?>
		<tr>
			<td><?php esc_html_e( 'XML Reader', 'thevoux' ); ?>:</td>
			<td>
				<?php

...
class Thb_Theme_Admin {
	...
	public function thbDemos() {
		return array(
			...
			array(
				'import_file_name'         => 'Daily Dose',
				'import_file_url'          => 'http://themes.fuelthemes.net/theme-demo-files/voux-new/dailydose/new-demo-content.xml',
				'import_widget_file_url'   => 'http://themes.fuelthemes.net/theme-demo-files/voux-new/dailydose/widget_data.json',
				'import_theme_options_url' => 'http://themes.fuelthemes.net/theme-demo-files/voux-new/dailydose/theme-options.txt',
				'import_image'             => self::$thb_theme_directory_uri . 'assets/img/admin/demos/homepages/dailydose.jpg',
				'import_demo_url'          => 'https://thevoux.fuelthemes.net/daily-dose',
			),
			array(
				'import_file_name'         => 'Marion Roberts',
				'import_file_url'          => 'http://themes.fuelthemes.net/theme-demo-files/voux-new/marion/new-demo-content.xml',
				'import_widget_file_url'   => 'http://themes.fuelthemes.net/theme-demo-files/voux-new/marion/widget_data.json',
				'import_theme_options_url' => 'http://themes.fuelthemes.net/theme-demo-files/voux-new/marion/theme-options.txt',
				'import_image'             => self::$thb_theme_directory_uri . 'assets/img/admin/demos/homepages/marion.jpg',
				'import_demo_url'          => 'https://thevoux.fuelthemes.net/marion-roberts',
			),
		);
	}
	/**

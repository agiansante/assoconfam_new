	...
	array(
		...
		'params'      => array(
			...
			array(
				...
				'value'       => array(
					'Black'         => 'black',
					'Black Border'  => 'transparent-black',
					'White'         => 'white',
					'White Border'  => 'transparent-white',
					'Accent'        => 'accent',
					'Accent Border' => 'transparent-accent',
				),
		...
		'params'      => array(
			array(
				...
				'options'     => array(
					...
					'style14'    => Thb_Theme_Admin::$thb_theme_directory_uri . '/assets/img/admin/postgrid/style14.png',
					'style15'    => Thb_Theme_Admin::$thb_theme_directory_uri . '/assets/img/admin/postgrid/style15.png',
					'style16'    => Thb_Theme_Admin::$thb_theme_directory_uri . '/assets/img/admin/postgrid/style16.png',
				),
			...
			array(
				...
				'dependency'  => array(
					'element' => 'style',
					'value'   => array( 'style1', 'style4', 'style11', 'style8', 'style10', 'style13', 'style15', 'style16' ),
				),
			),
			array(
				'type'        => 'loop',
			...
			array(
				'type'        => 'dropdown',
				'heading'     => esc_html__( 'Load More Style', 'thevoux' ),
				...
				'description' => esc_html__( 'This changes the look of the Load More button.', 'thevoux' ),
			),
			array(
				'type'        => 'checkbox',
		...
		'params'      => array(
			array(
				...
				'options'     => array(
					...
					'style12' => Thb_Theme_Admin::$thb_theme_directory_uri . '/assets/img/admin/postcarousel/style12.png',
				),
				'description' => esc_html__( 'This changes the style of the posts', 'thevoux' ),
			),
			array(
	...
	array(
		...
		'params'      => array(
			...
			array(
				...
				'heading'     => esc_html__( 'Pagination', 'thevoux' ),
				'param_name'  => 'pagination',
				'group'       => esc_html__( 'Controls', 'thevoux' ),
				'value'       => array(
					esc_html__( 'Yes', 'thevoux' ) => 'true',
				),
				'description' => esc_html__( 'If enabled, this will show pagination circles underneath', 'thevoux' ),
			...
			array(
				'type'        => 'textfield',
				'heading'     => esc_html__( 'Slider Height', 'thevoux' ),
				'param_name'  => 'thb_slider_height',
				'group'       => esc_html__( 'Styling', 'thevoux' ),
				'description' => esc_html__( 'You can use different units such as vw, vh and px.', 'thevoux' ),
			),
			array(
				'type'        => 'textfield',
				'heading'     => esc_html__( 'Slider Mobile Height', 'thevoux' ),

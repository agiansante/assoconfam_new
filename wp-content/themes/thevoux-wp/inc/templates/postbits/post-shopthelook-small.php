...
<aside class="thb-shop-the-look-small">
	...
	<?php
	while ( $shoptheloop->have_posts() ) :
		$shoptheloop->the_post();
		?>
		...
		if ( $product->is_type( 'external' ) ) {
			?>
			target="_blank"<?php } ?> href="<?php echo esc_url( $permalink ); ?>" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
